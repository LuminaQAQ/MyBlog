import{_ as s,c as i,o as a,a3 as n}from"./chunks/framework.D5qxx6u8.js";const y=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"我的笔记/Scss.md","filePath":"我的笔记/Scss.md"}'),l={name:"我的笔记/Scss.md"},h=n(`<h2 id="_1-变量定义" tabindex="-1">1. 变量定义 <a class="header-anchor" href="#_1-变量定义" aria-label="Permalink to &quot;1. 变量定义&quot;">​</a></h2><div class="language-sass vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">sass</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">// 1. 变量定义</span></span>
